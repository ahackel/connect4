...
System.registerModule("../../js/Connect4Game", [], function() {
  "use strict";
  var __moduleName = "../../js/Connect4Game";
  var Block = System.get("../../js/Block").Block;
  ...
  var HUMAN_PLAYERS = [true, false, false, false];
...
System.registerModule("../../js/connect4App.js", [], function() {
  "use strict";
  var __moduleName = "../../js/connect4App.js";
  var Connect4Game = System.get("../../js/Connect4Game").Connect4Game;
  var blockSize;
  var game;
  function adjustSize() {
    var portrait = window.innerWidth < window.innerHeight;
    var nx = window.innerWidth / ((portrait) ? 7 : 9);
